...
// visualize.
//
// See the contrib package ( https://pkg.go.dev/github.com/nowfred/dd-trace-go/contrib )
...
// (See the net/http contrib package for more examples https://pkg.go.dev/github.com/nowfred/dd-trace-go/contrib/net/http):
//
...
// https://godoc.org/github.com/nowfred/dd-trace-go/contrib
package tracer // import "github.com/nowfred/dd-trace-go/ddtrace/tracer"
